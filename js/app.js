...
***************************************************************************** */
        ...
        window.onload = function() {
            ...
            const buttonsNavBlog = document.querySelectorAll(".cards-blog__title");
            if (buttonsNavBlog.length != 0) {
                const elementsItems = document.querySelectorAll(".cards-blog__item");
                ...
                function clickBlog(e) {
                    const targetElement = e.target;
                    const activeElement = document.querySelector(".cards-blog__title.active");
                    const elements = document.querySelectorAll(".cards-blog__item");
